<!-- CANONICAL. CLAUDE.md is a byte-for-byte copy of this file, generated by
     build.py, because the two agents look for different filenames: Claude Code
     reads CLAUDE.md, Codex reads AGENTS.md. Copying beats importing - it does
     not depend on either CLI supporting an include syntax, and it cannot drift.
     EDIT THIS FILE. Anything you write in CLAUDE.md gets overwritten. -->
